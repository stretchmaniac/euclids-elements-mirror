...
class Geo{
    ...
    public static Point lineLineIntersection(Point lineP1, Point lineP2, Point lineP3, Point lineP4){
        // my goal is to make this a short as possible. I think I've done pretty well (note I can roll normal into the next line, 
        // so I count effectively 4 lines)
        ...
        return lineP3.plus(lineP4.minus(lineP3).scaleBy(-lineP3.minus(lineP1).dot(normal) / t));
    }
    ...
    public static Point lineCircleIntersection(Point circleCenter, Point circleEdge, Point lineP1, Point lineP2, boolean solutionClockwise){
        ...
        if((rad.cross2d(firstSol.minus(circleCenter)) >= 0) == !solutionClockwise){
            return firstSol;
        }
        return secondSol;
    }
    ...
    public static Point circleCircleIntersection(Point circle1Center, Point circle1Edge, Point circle2Center, Point circle2Edge, boolean solutionClockwise){
        ...
        if((rad.cross2d(sol1.minus(circle1Center)) >= 0) == !solutionClockwise){
            return sol1;
        }
        return sol2;
    }
